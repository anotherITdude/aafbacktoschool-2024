    ...
    <div className="">
      <div className="flex flex-col md:flex-row justify-center items-center bg-webWhite">
        <div
          ...
          competition_section bg-right-top md:bg-cover    bg-no-repeat h-[540px]"
        >
          <div className="flex flex-col md:flex-row justify-center items-center w-full">
            ...
            <div className="flex flex-col gap-y-0 max-w-[500px] capitalize">
              ...
              >
                ...
                <p
                  className={`bg-webSkyBlue text-webWhite w-full md:w-[50%] m-auto pt-1 pb-1`}
                >
                  {t.and_more}
                </p>
              </div>
              ...
              <div className={`flex justify-center gap-x-8 mt-4 text-webBlue  ${locale === "/" ? "text-left" : "text-right"}`}>
                ...
                <div>
                  ...
                  <div className="flex-col font-Circular-Bold text-xs">
                    ...
                    <p>{t.winners_announcement_date}</p>
                  </div>
                </div>
              </div>
            </div>
